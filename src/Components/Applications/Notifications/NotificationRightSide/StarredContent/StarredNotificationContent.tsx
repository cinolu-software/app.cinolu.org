...
import {handleEnvelope, handleInterview, removeFromFavorite } from "@/Redux/Reducers/NotifcationSlice/notificationSlice";
import { CommonDataType} from "@/Types/Notifications/NotificationType";
import { Badge, Input, Label} from "reactstrap";


const StarredNotificationContent: React.FC<CommonDataType> = ({ data, ids }) => {
...
export default StarredNotificationContent;