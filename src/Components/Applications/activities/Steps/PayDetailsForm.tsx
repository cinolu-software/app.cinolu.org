...
import {setPayDetailsFormValues} from "@/Redux/Reducers/ActivitySlice";
...
const PayDetailsForm :React.FC<ActivityFormTabContentPropsType> = ({ callbackActive }) => {
    const { payDetailsFormValues } = useAppSelector((state) => state.activity);
