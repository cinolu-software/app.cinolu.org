...
import {setAccountType} from "@/Redux/Reducers/ActivitySlice";
import ShowError from "@/Components/Applications/activities/Steps/ShowError";
import {SelectAmountData} from "@/Data/Application/Project/new";

const SelectAccount :React.FC<ActivityFormTabContentPropsType> = ({ callbackActive }) => {

    const { accountType } = useAppSelector((state) => state.activity);
