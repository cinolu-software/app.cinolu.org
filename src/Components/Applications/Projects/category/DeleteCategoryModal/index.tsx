        ...
        <Col xl="4">
            <CardBody className="badge-spacing">
                <CommonModal
                    ...
                    toggle={() => dispatch(setModalDeleteCategory({ isOpen: false, category: null }))}
                    ...
                    <div className="modal-toggle-wrapper">
                        ...
                        {selectedCategoryData && (
                            <p className="text-center">
                                Vous êtes sur le point de supprimer cette catégorie : <strong>{selectedCategoryData.name}</strong>
                            </p>
                        )}
                        <div className="d-flex justify-content-center mt-5">
                            <Button
                                color="secondary"
                                className="me-2"
                                onClick={() => dispatch(setModalDeleteCategory({ isOpen: false, category: null }))}
                            >
                                {"Fermer"}
                            </Button>
