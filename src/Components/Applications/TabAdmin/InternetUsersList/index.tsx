...
import { ProductListTableData, ProductListTableDataColumn } from "@/Data/Application/UsersData/MembersData";
import React, { useMemo, useState } from "react";
import DataTable from "react-data-table-component";
import { Card, CardBody, Col, Container, Input, Label, Row } from "reactstrap";
import { CollapseFilterData } from "./CollapseFilterData";
import { InternetUserListFilterHeader } from "./InternetUserListFilterHeader";

const InternetUsersListContainer = () => {
...
export default InternetUsersListContainer;
