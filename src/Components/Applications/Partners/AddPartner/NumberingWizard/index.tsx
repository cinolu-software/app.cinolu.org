...
const NumberingWizard = () => {
    ...
    const getPartnerData = (name: string, value: any) => {
        dispatch(
            setFormValue({
                field: name,
                value,
    ...
    const renderStep = () => {
        switch (numberLevel) {
            case 1:
                return <StepOne formValue={formValue} onChange={getPartnerData} />;
            case 2:
                return <StepTwo formValue={formValue} onChange={getPartnerData} />;
            case 3:
                return <StepThree formValue={formValue} onChange={getPartnerData} />;
            case 4:
                return (
