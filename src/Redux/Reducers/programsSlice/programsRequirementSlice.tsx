...
const ProgramsRequirementSlice = createSlice({
    name: "programs",
    initialState,
    reducers: {
...
export const { setModalCreateProgram, setModalEditProgram, setModalDeleteProgram } = ProgramsRequirementSlice.actions;
...
export default ProgramsRequirementSlice.reducer;